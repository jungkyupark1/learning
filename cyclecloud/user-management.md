...
1. Cyclecloud GUI 접속 및 User Setting

![1780363224811](image/user-management/1780363224811.png)

2. Users 탭에서 Create

![1780363230302](image/user-management/1780363230302.png)

3. User 추가

Roles: 해당 User가 Cyclecloud GUI 에 접근할 필요가 없다면 아무것도 체크 안해도 됨

Node Settings: Keypair (pem 파일) 기반으로 노드에 접속하려면 등록 필요
...
노드 OS 상의 Group이
아닌 Cyclecloud Cluster 의 Groups을
의미함
...
내부에서 jetpack 데몬이 동작하여 GUI에서 사용자 등록하면 바로 적용됨
...
## 7. 스케줄러 노드에 Password로 SSH 접속

### 7-1. Node Admin 사용자 비밀번호 변경
...
### 7-2. nodeadmin으로 스케줄러 노드에 접속 및 사용자 비밀번호 등록
